...
describe('Get Search Results API Handler', () => {
  it('should make a successful API call', async () => {
    (geoNetworkClient.post as jest.Mock).mockResolvedValue(new ApiResponse({},200, true));
  ...
  it('should handle API call error', async () => {
    (geoNetworkClient.post as jest.Mock).mockResolvedValue(new ApiResponse({message: "Unable to fetch the search results."},400, false));
